...
def _parse_teams(html: HTMLParser) -> list[dict]:
    ...
    for mod in ("mod-1", "mod-2"):
        ...
        team_id = ""
        href = html.css_first(f"a.match-header-link.{mod}")
        ...
        teams.append({"name": name, "team_id": team_id, "tag": tag, "logo": "", "score": "", "is_winner": False})
